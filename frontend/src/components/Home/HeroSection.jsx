      ...
      <div className="container">
        <div className="title">
          ...
          <p>
            ...
            animi earum! Recusandae optio voluptatem cupiditate eveniet
            molestias voluptates dolor est rerum nisi. Aspernatur eligendi esse
            sequi dicta quisquam suscipit.
          </p>
        </div>
        <div className="image">
